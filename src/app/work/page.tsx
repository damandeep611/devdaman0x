    ...
    <div className="mt-12 sm:mt-24 md:mt-32 max-w-7xl mx-auto px-6">
      ...
      <div className="mb-24 flex flex-col md:flex-row md:items-end justify-between gap-12 border-b border-border pb-12">
        ...
        <div className="max-w-xl text-lg md:text-xl leading-relaxed text-muted-foreground font-light">
          <p>
            Specializing in <span className="text-foreground font-medium">high-performance interfaces</span> and distributed systems. 
            Currently focused on the Next.js ecosystem and Golang backend services.
          </p>
        </div>
      </div>
