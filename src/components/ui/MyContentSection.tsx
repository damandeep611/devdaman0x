...
const blogPosts = [
  {
    title: "Mastering Server State with React Query",
    description: "Why you should stop using Redux for server state and how React Query simplifies your data fetching logic.",
    date: "Dec 12, 2024",
    tag: "React",
  ...
  },
  {
    ...
    description: "Understanding Goroutines, Channels, and Select statements to build high-performance concurrent systems.",
    date: "Nov 28, 2024",
    tag: "Golang",
  ...
  },
  {
    ...
    description: "A comprehensive guide to creating optimized Docker images for your Next.js applications using multi-stage builds.",
    date: "Nov 15, 2024",
    tag: "DevOps",
  ...
  },
  {
    ...
    description: "Key principles for designing scalable distributed systems that can handle high traffic and ensure availability.",
    date: "Oct 30, 2024",
    tag: "System Design",
                ...
                {blogPosts.map((post, index) => (
                    ...
                    >
                        ...
                        <div className="flex-1 space-y-3">
                            ...
                            <button className="flex items-center gap-2 text-sm font-semibold text-foreground mt-2 group/btn">
                                Read Article 
                                <ArrowRight size={14} className="group-hover/btn:translate-x-1 transition-transform text-muted-foreground" />
                            </button>
                        </div>
                    </motion.div>
                ))}
                ...
                <div className="relative z-10 flex flex-col h-full justify-between">
                  <div>
                    ...
                    <p className="text-muted-foreground mb-8 leading-relaxed font-light text-sm max-w-sm">
                      Deep dives into system design, patterns, and the
                      occasional rant about complexity.
                    </p>
                  </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="mb-8 leading-relaxed font-light text-sm text-muted-foreground">
                  ...
                  learning. Code snippets, raw notes, and resources on
                  everything from backend internals to algorithms.
                </p>
