...
import { Mail, Check, Copy, MessageSquare, X, ArrowLeft, Send, Loader2, Calendar } from "lucide-react";
                 ...
                 <AnimatePresence mode="wait">
                     ...
                     {contactView === "message" && (
                        <motion.div
                            ...
                            exit={{ opacity: 0, x: -20 }}
                        >
                             <form onSubmit={handleSubmit} className="space-y-3 bg-white dark:bg-zinc-800 rounded-xl p-3 border border-zinc-200/50 dark:border-zinc-700/50">
                                <div className="space-y-3">
                                    <div className="space-y-1">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700/50 rounded-xl px-3 py-2 text-sm text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-1 focus:ring-zinc-400 dark:focus:ring-zinc-500 transition-all"
                                        />
                                    </div>
                                    <div className="space-y-1">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700/50 rounded-xl px-3 py-2 text-sm text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-1 focus:ring-zinc-400 dark:focus:ring-zinc-500 transition-all resize-none"
                                        />
                                    </div>
                                </div>
                                <button
                     ...
                     {contactView === "calendar" && (
                        <motion.div
                            ...
                            animate={{ opacity: 1, x: 0 }}
                            exit={{ opacity: 0, x: -20 }}
                            className="h-[400px] bg-white dark:bg-zinc-800 rounded-xl overflow-hidden border border-zinc-200 dark:border-zinc-700/50 relative"
                        >
                             <iframe
