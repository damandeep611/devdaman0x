        ...
        <div className="lg:col-span-4 space-y-12">
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-full bg-recording-red/10 flex items-center justify-center text-recording-red">
                <svg
            ...
            <h3 className="text-5xl font-serif italic text-foreground leading-[1.1]">
        ...
        <div className="lg:col-span-8 relative">
          <div className="lg:col-span-8 relative">
            ...
            <motion.div
              ...
              className="absolute -top-10 -left-12 z-30 pointer-events-auto"
            >
              <div className="relative bg-[#fff9c4] dark:bg-[#fff176] p-8 shadow-[10px_10px_30px_rgba(0,0,0,0.15)] rounded-sm border border-amber-200/50 max-w-[200px]">
                {/* Translucent Washi Tape */}
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-16 h-8 bg-brand-green/30 backdrop-blur-md border border-white/20 -rotate-2 z-10" />

                <p className="font-handwriting text-amber-900 text-2xl leading-tight">
                  Don&apos;t skip <br /> the messy <br /> parts.
                </p>
                <div className="mt-4 flex gap-1">
                  <div className="w-2 h-2 rounded-full bg-amber-900/10" />
                  <div className="w-10 h-1 rounded-full bg-amber-900/10" />
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="absolute -top-12 -left-4 md:-left-16 z-30 pointer-events-none">
            <motion.div
              initial={{ rotate: -5, opacity: 0 }}
              whileInView={{ rotate: -8, opacity: 1 }}
              className="relative bg-note-bg p-6  shadow-2xl rounded-sm max-w-[180px] border border-note-border"
            >
              {/* Tape Effect */}
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-12 h-6 bg-brand-green/10 border border-brand-green/5 backdrop-blur-sm -rotate-2 z-10" />

              <p className="font-(family-name:--font-geist-caveat) text-note-text text-2xl md:text-3xl leading-tight">
                I share my learnings <br /> stuff here <br /> as well.
              </p>
            </motion.div>
          </div>
        </div>
